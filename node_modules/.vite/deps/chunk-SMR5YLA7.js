...
var stdin_default74 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderImages = () => createVNode(Swipe, {
      ...
      default: () => [props2.images.map((image, index) => createVNode(stdin_default73, {
        "src": image,
        "show": props2.show,
        "active": state.active,
...
function initInstance2() {
  ({
    ...
    setup() {
      ...
      return () => createVNode(stdin_default74, mergeProps(state, {
        "onClosed": onClosed,
        "onUpdate:show": toggle
      }), null);
    }
...
function initInstance3() {
  ({
    ...
    setup() {
      ...
      return () => createVNode(stdin_default80, mergeProps(state, {
        "onUpdate:show": toggle
      }), null);
    }
  }));
...
var stdin_default82 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderKeys = () => keys.value.map((key) => {
      ...
      return createVNode(stdin_default81, {
        "key": key.text,
        "text": key.text,
        "type": key.type,
        "wider": key.wider,
    ...
    const renderSidebar = () => {
      if (props2.theme === "custom") {
        return createVNode("div", {
          "class": bem74("sidebar")
        }, [props2.showDeleteKey && createVNode(stdin_default81, {
          "large": true,
...
var stdin_default90 = defineComponent({
  ...
  setup(props2) {
    ...
    return () => createVNode("div", {
      "class": bem82()
    }, [targetNumArr.value.map((_, i) => createVNode(stdin_default89, {
...
var stdin_default102 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderAvatar = () => {
      if (props2.avatar) {
        return createVNode(stdin_default99, {
    ...
    const renderTitle = () => {
      if (props2.title) {
        return createVNode(stdin_default97, {
          "round": props2.round,
    ...
    const renderRows = () => Array(+props2.row).fill("").map((_, i) => createVNode(stdin_default101, {
      "key": i,
      "round": props2.round,
...
var stdin_default117 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderPreviewItem = (item, index) => {
      ...
      return createVNode(stdin_default116, mergeProps({
        "item": item,
        "index": index,
...
export {
  ...
  version,
  install,
  stdin_default122 as stdin_default
};
//# sourceMappingURL=chunk-SMR5YLA7.js.map
